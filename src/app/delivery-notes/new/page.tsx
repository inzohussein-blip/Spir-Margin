  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-ink-gray-5">
        <Link href="/delivery-notes" className="hover:text-brand">← {t(locale, "Delivery Notes")}</Link>
      </div>
      <h1 className="text-2xl font-bold text-ink-gray-8">{t(locale, "New Delivery Note")}</h1>
      <DeliveryNoteForm
