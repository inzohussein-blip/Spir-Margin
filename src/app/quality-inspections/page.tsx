                    ...
                    <td className="px-4 py-2">
                      {q.status !== "cancelled" ? (
                        <div className="flex gap-2">
                          <ValidatedForm action={evaluateQualityInspectionForm}>
                            <input type="hidden" name="id" value={q.id} />
                            <button className="rounded-md bg-brand px-2.5 py-1 text-xs font-medium text-white hover:bg-brand-dark">{t(locale, "Evaluate")}</button>
                          </ValidatedForm>
                          <ValidatedForm action={cancelQualityInspectionForm}>
                            <input type="hidden" name="id" value={q.id} />
