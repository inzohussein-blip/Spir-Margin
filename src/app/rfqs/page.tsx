  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-ink-gray-8">Requests for Quotation</h1>
      ...
      <Panel title={`RFQs (${rows.length})`}>
        {rows.length === 0 ? (
          <EmptyRow text="No RFQs yet — ask several suppliers to quote the same items" />
        ) : (
