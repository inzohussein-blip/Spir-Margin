  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-ink-gray-8">Stock Reconciliation</h1>
      ...
      <Panel title={`Counts (${rows.length})`}>
        {rows.length === 0 ? (
          <EmptyRow text="No stock counts — reconcile kit batch quantities to a physical count" />
        ) : (
