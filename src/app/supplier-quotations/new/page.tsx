  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-ink-gray-5">
        <Link href="/supplier-quotations" className="hover:text-brand">← {t(locale, "Supplier Quotations")}</Link>
      </div>
      <h1 className="text-2xl font-bold text-ink-gray-8">{t(locale, "New Supplier Quotation")}</h1>
