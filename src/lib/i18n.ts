...
const ar: Record<string, string> = {
  ...
  "withdrawal": "سحب",
  // misc UI strings
  "You need an administrator account to manage users.": "تحتاج حساب مدير لإدارة المستخدمين.",
  "Manage who can sign in and their role.": "تحكّم بمن يمكنه الدخول وبأدوارهم.",
  "→ Purchase": "→ شراء",
  "No description.": "لا يوجد وصف.",
  "You need an administrator account to manage settings.": "تحتاج حساب مدير لإدارة الإعدادات.",
