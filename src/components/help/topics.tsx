  ...
  // ------------------------------------------------------------------ getting started
  {
    ...
    render: (locale) => (
      <div className="space-y-4">
        ...
        <HelpSection title="اختصارات توفّر الوقت" icon={SearchIcon}>
          <Bullets>
            <li>
              <strong>البحث يفهم الكتابة العربية بأشكالها</strong>: «احمد» تجد «أحمد»، و«مكتبه» تجد «مكتبة»، و«الكندى» تجد
              «الكندي»، والأرقام الهندية كالعربية. في شريط البحث (<Key>Ctrl</Key>+<Key>K</Key>) وفي كل القوائم.
            </li>
            <li>
              <strong>«{t(locale, "Copy")}»</strong> في صفحة الفاتورة وأمر الشراء وطلب البيع، وفي قائمة أوامر البيع: مستند جديد
              بالزبون والأصناف نفسها، بتاريخ اليوم.
            </li>
            <li>الزبائن والمورّدون والمخازن المستخدمة مؤخراً تظهر أولاً في القوائم المنسدلة.</li>
            <li>
              <strong>قارئ الباركود</strong> في نقطة البيع: امسح رمز الصنف فيُضاف إلى السلّة مباشرةً (أو اكتب الرمز واضغط <Key>Enter</Key>).
            </li>
            <li>كل قائمة تتذكّر آخر بحث فيها عند العودة إليها؛ «{t(locale, "Clear")}» يمسحه.</li>
            <li>
              عند بيع كِتّ يظهر تحت الصنف رقم الدفعة التي ستُصرف أولاً وتاريخ انتهائها، بلون تحذيري إن بقي أقل من 30 يوماً.
            </li>
            <li>
              في صفحة طباعة أيّ مستند: زرّ <strong>«{t(locale, "WhatsApp")}»</strong> يفتح المحادثة برسالة فيها الرقم والمبلغ (احفظ الـ PDF
              من زرّ الطباعة وأرفقه)، والمجموع يظهر بالدولار والدينار معاً.
            </li>
            <li>زرّ <strong>«{t(locale, "Excel")}»</strong> في كل قائمة ينزّل ملف إكسل حقيقي من اليمين إلى اليسار.</li>
          </Bullets>
        </HelpSection>
    ...
    render: (locale) => (
      <div className="space-y-4">
        ...
        <HelpSection title="ربط حواسيب الشركة ببعضها" icon={RefreshCwIcon}>
          ...
          />
          <Note>
            إن أنشأ حاسوبان سجلّين مختلفين بالرمز نفسه قبل أن يتزامنا (مختبر <Code>LAB-9</Code> هنا وآخر هناك)، يبقى
            السجلّان كلاهما: الذي وصل أولاً يحتفظ برمزه، والآخر تُضاف لرمزه لاحقة قصيرة (<Code>LAB-9-A1B2</Code>). تظهر هذه
            التغييرات في <UiPath parts={[t(locale, "Monitoring"), t(locale, "Sync Health")]} href="/monitoring/sync" />، ويمكن
            تعديل الرمز بعدها إلى ما تشاء.
          </Note>
        </HelpSection>
