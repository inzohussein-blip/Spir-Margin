...
export function SalesInvoiceForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <Card>
        <CardHeader><CardTitle>Sales Invoice</CardTitle></CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-sm">
          <label className="block">
            <span className="font-medium text-ink-gray-8">Invoice no.</span>
          ...
          <label className="block">
            <span className="font-medium text-ink-gray-8">Due date</span>
