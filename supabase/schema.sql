-- =====================================================================
-- Spir-Margin — combined schema (all 58 migrations + seed)
--
...
--
-- Default login after bootstrap:  admin@spir.local  /  admin1234
-- CHANGE THIS PASSWORD immediately from the Account page after first sign-in.
-- =====================================================================
